...
u32  MSTK_u32GetElapsedTime      (void)
{
	...
	u32 Local_u32ElapsedTime = (MSTK_LOAD)-(MSTK_VAL);
	return Local_u32ElapsedTime;
}
u32  MSTK_u32GetRemainingTime	 (void)
{
	u32 Local_u32RemainingTime = MSTK_VAL;
